...
export default function Welcome(props) {
    ...
    const [posts, setPosts] = useState([]);
      ...
      const getData=()=>{
        setLoading(true);
          fetch(
              "https://api.openweathermap.org/data/2.5/forecast?lat=44.34&lon=10.99&appid=9ae17905c4a2dc496b5467a1cf7d6648")
                          .then((res) => res.json())
                          .then((json) => 
                              setPosts(json)).then(setLoading(false))
      }
      useEffect(() => {
        getData();
      }, []);
    //   console.log(posts.city.name);
    return (
        <>
            <Head title="Welcome" />
